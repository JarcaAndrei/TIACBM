...
from transformers import BertForSequenceClassification,BertForMaskedLM, AutoModelForSequenceClassification 
from trainer_roberta import TrainerRoberta
import argparse
import torch
...
if __name__ == '__main__':
    ...
    #probs = [0,0,0,0.3,0,0.25,0.3,0,0.25,0.3,0,0.25,0.3,0,0.25,0.3,0,0.25]
    #probs = np.linspace(15,0,15)
    #probs=[0.15]*15
    #probs = [0]*15
    #probs = [0, 0, 0]  *5
    ...
    trainer = TrainerRoberta(model, train, test, add_optimizer_params_lr_scale, args,build_optimizer_bert, probs, sentiment_dict = sentiwordnet_words)
