...
tokenizer = AutoTokenizer.from_pretrained('FacebookAI/roberta-base', max_length=max_len)
model = AutoModelForSequenceClassification.from_pretrained('FacebookAI/roberta-base', num_labels=num_labels).to(device)
...
HFDataset.from_dict(sorted_dataset).to_json("sorted_20news_roberta.json")
print("Sorted dataset saved as sorted_20news_roberta.json")
