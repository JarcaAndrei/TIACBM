...
DATA_PATH = "path/to/problem0001_or_problem0005"
BATCH_SIZE = 8
EPOCHS = 20
LR = 1e-4
LR = 5e-5
...
HFDataset.from_dict(sorted_dataset).to_json("sorted_pan19_5_corr.json")
print("Sorted dataset saved as sorted_pan19_5_corr.json")